								...
								while ($row=mysqli_fetch_array($query)) {
									?>
										<div class="row">
											...
											<div class="col-md-6">
												<table>
													<tr><td>Ime</td><td><b><?php echo $row["product_title"]; ?></b> </td></tr>
													<tr><td>Cena</td><td><b><?php echo "RSD ".$row["product_price"]; ?></b></td></tr>
													<tr><td>Kolicina</td><td><b><?php echo $row["qty"]; ?></b></td></tr>
													<tr><td>Id</td><td><b><?php echo $row["trx_id"]; ?></b></td></tr>
												</table>
											</div>
										</div>
									<?php
